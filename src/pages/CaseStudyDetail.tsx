  ...
  if (!study) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-white px-6 text-center">
        <h1 className="text-2xl font-semibold text-[#0b2416]">Case study not found</h1>
        <Link to="/case-studies" className="text-emerald-600 hover:underline">
    ...
    <div className="min-h-screen bg-white">
      <header className="border-b border-emerald-900 bg-[#0b2416] text-white">
        <div className="mx-auto flex max-w-3xl items-center justify-between px-6 py-4 text-sm">
          <Link to="/case-studies" className="font-semibold tracking-wide text-emerald-100 hover:text-white">
            ← Case Studies
          </Link>
        ...
        <div className="mx-auto max-w-3xl px-6 pb-14 pt-4">
          ...
          <p className="mt-3 text-lg text-emerald-100/90">{study.tagline}</p>
      ...
      <section className="mx-auto max-w-3xl px-6 py-14">
        ...
        <p className="mt-10 leading-relaxed text-slate-600">{study.closing}</p>
      </section>
